...
build/pyodide.js: src/js/*.js src/js/pyproxy.gen.js src/js/node_modules/.installed
...
src/js/pyproxy.gen.js : src/core/pyproxy.* src/core/*.h
	...
	rm -f $@
	echo "// This file is automatically generated by applying the C preprocessor to core/pyproxy.js" >> $@
