/* This is a copy of the auto-generated pyconfig.h, edited to fix somethings
   about the emscripten environment that are not correctly detected by the
   configure script. The manually changed elements are indicted below with
   *CHANGED*.
*/
