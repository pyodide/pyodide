...
class JsProxy:
    ...
    def to_file(self, file: IOBase, /) -> Any:
    ...
    def from_file(self, file: IOBase, /) -> Any:
    ...
    def _into_file(self, file: IOBase, /) -> Any:
...
def destroy_proxies(pyproxies: JsProxy, /) -> Any:
