...
def run_js(code: str, /) -> Any:
    ...
    JavaScript's `eval <https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/eval>`_, if ``code`` is not a string we raise a :any:`TypeError`.
    """
