...
async function main(){
    ...
    expectType<Promise<typeof pyodide>>(loadPyodide({ indexURL : "blah", fullStdLib : true }));
    ...
    expectType<Promise<void>>(pyodide.loadPackagesFromImports("import some_pkg",(x) => console.log(x)));
    expectType<Promise<void>>(pyodide.loadPackagesFromImports("import some_pkg",(x) => console.log(x), (x) => console.warn(x)));
    ...
    expectType<Promise<void>>(pyodide.loadPackage(["blah", "blah2"],(x) => console.log(x), (x) => console.warn(x)));
