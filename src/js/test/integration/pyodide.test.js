...
describe("Pyodide", () => {
      ...
      describe("micropip", () => {
            before(async () => {
                  ...
                  const installedPackages = await chai.assert.isFulfilled(page.evaluate(factory));
            ...
            it("install", async () => {
                  const factory = async () => {
                        await pyodide.runPythonAsync('import micropip; await micropip.install("snowballstemmer")');
