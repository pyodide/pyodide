...
describe("calculateInstallBaseUrl", () => {
      ...
      it("Should extract base URL from absolute HTTP URL", () => {
            const result = calculateInstallBaseUrl("https://cdn.example.com/pyodide/pyodide-lock.json");
            chai.assert.equal(result, "https://cdn.example.com/pyodide/");
      });

      it("Should extract base URL from file URL", () => {
            const result = calculateInstallBaseUrl("file:///tmp/pyodide/pyodide-lock.json");
      ...
      it("Should handle URL with query parameters", () => {
            const result = calculateInstallBaseUrl("https://cdn.example.com/pyodide/pyodide-lock.json?v=1.0");
            chai.assert.equal(result, "https://cdn.example.com/pyodide/");
      });

      it("Should handle URL with hash fragment", () => {
            const result = calculateInstallBaseUrl("https://cdn.example.com/pyodide/pyodide-lock.json#section");
            chai.assert.equal(result, "https://cdn.example.com/pyodide/");
      });

      it("Should handle URL with both query parameters and hash", () => {
            const result = calculateInstallBaseUrl("https://cdn.example.com/pyodide/pyodide-lock.json?v=1.0#section");
            chai.assert.equal(result, "https://cdn.example.com/pyodide/");
      });

      it("Should handle URL with username and password", () => {
            const result = calculateInstallBaseUrl("https://user:pass@cdn.example.com/pyodide/pyodide-lock.json");
