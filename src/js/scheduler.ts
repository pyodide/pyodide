import { IN_BROWSER_MAIN_THREAD, IN_NODE, IN_DENO, IN_SAFARI } from "./environments";
...
function scheduleCallbackImmediate(callback: () => void) {
      ...
      } else if (!IN_SAFARI && !IN_DENO && typeof globalThis.MessageChannel === "function") {
      ...
      } else if (IN_BROWSER_MAIN_THREAD && typeof globalThis.postMessage === "function") {
