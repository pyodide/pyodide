...
import type { TypedArray, Module, PackageData, FSType, Lockfile } from "./types";
...
declare function _createPyodideModule(settings: EmscriptenSettings): Promise<Module>;
...
export async function loadPyodide(
      ...
      options_.cdnUrl = options_.packageBaseUrl ?? `https://cdn.jsdelivr.net/pyodide/v${version}/full/`;
...
`);
      ...
      const pyodide = API.finalizeBootstrap(snapshotConfig, options._snapshotDeserializer);
