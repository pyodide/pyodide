...
declare global {
      ...
      export const _python2js_custom: (
            ...
            dict_converter: null | ((array: Iterable<[key: string, value: any]>) => any),
            default_converter:
                  | null
                  | ((
                          obj: PyProxy,
      ...
      export const _pyproxy_getflags: (ptr: number, is_json_adaptor: boolean) => number;
      export const __pyproxy_type: (ptr: number) => string;
      export const __pyproxy_repr: (ptr: number) => string;
      export const __pyproxy_getitem: (obj: number, key: any, cache: Map<string, any>, is_json_adaptor: boolean) => any;
      ...
      export const __pyproxy_iter_next: (ptr: number, cache: Map<string, any>, is_json_adaptor: boolean) => any;
      export const __pyproxyGen_Send: (ptr: number, arg: any) => IteratorResult<any>;
      export const __pyproxyGen_return: (ptr: number, arg: any) => IteratorResult<any>;
      export const __pyproxyGen_throw: (ptr: number, arg: any) => IteratorResult<any>;
      ...
      export const __pyproxy_getattr: (ptr: number, attr: string, cache: Map<string, any>) => any;
      export const __pyproxy_setattr: (ptr: number, attr: string, value: any) => number;
      export const __pyproxy_delattr: (ptr: number, attr: string) => number;
      export const __pyproxy_hasattr: (ptr: number, attr: string) => number;
      export const __pyproxy_slice_assign: (ptr: number, start: number, stop: number, val: number) => any[];
...
/** @hidden */
export type PackageType = "package" | "cpython_module" | "shared_library" | "static_library";
