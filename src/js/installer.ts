...
export class Installer {
      ...
      async install(buffer: Uint8Array, filename: string, installDir: string, metadata?: ReadonlyMap<string, string>) {
            ...
            await this.#dynlibLoader.loadDynlibsFromPackage({ file_name: filename }, dynlibs);
      }
}
