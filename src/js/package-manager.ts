import "./constants";
import { Lockfile, PackageData, InternalPackageData, PackageLoadMetadata } from './types';
...
class PackageManager {
    ...
    constructor(_module: Module, api: API) {
        this.module = _module;
        this.api = api;
    }
 ...
 * @private
 */
export async function initializePackageIndex(lockFilePromise: Promise<Lockfile>) {
