 ...
 * JavaScript.
 *
 * Arbitrary JavaScript objects are referenced from C using an opaque JsRef value.
 *
...
JsRef
JsArray_slice_assign(JsRef idobj, int slicelength, int start, int stop, int step);
