 ...
 *    :class: warning
 *
 *    If you make a :js:class:`~pyodide.ffi.PyProxy` of :py:data:`sys.last_value`, you should be
 *    especially careful to :js:meth:`~pyodide.ffi.PyProxy.destroy` it when you are
