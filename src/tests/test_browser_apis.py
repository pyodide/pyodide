...
async def test_set_timeout_succeeded(selenium):
    ...
    from pyodide.browser import set_timeout
...
async def test_clear_timeout_succeeded(selenium):
    ...
    from pyodide.browser import clear_timeout, set_timeout
...
async def test_set_interval_succeeded(selenium):
    ...
    from pyodide.browser import clear_interval, set_interval
...
x;
    ...
    from pyodide.browser import add_event_listener, remove_event_listener
...
x;
    ...
    from pyodide.browser import remove_event_listener
