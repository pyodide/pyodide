...
- [marimo](https://github.com/marimo-team/marimo) is a reactive notebok that is compatible with Pyodide with an [online editor](https://marimo.app/) that runs completeing in the browser. These notebooks can also run as standalone applications or embedded in blogs.
