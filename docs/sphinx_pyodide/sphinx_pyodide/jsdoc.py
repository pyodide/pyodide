...
class PyodideAnalyzer:
    ...
    def flatten_suffix_tree(self):
        """Flatten self._doclets_by_path into a dictionary self.doclets.
        ...
        it...
        """
        tree = self._doclets_by_path._tree
        self.doclets = {}
        path = []
        iters = []
        ...
        while True:
            ...
            if isinstance(val, dict):
                ...
                path.append(key)
                self.doclets[tuple(reversed(path))] = val
                path.pop()
