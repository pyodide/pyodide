...
* `js2python` -- Translates types from javascript to python. Implicitly converts some basic types, leaves more complicated stuff to jsproxy.
* `jsproxy` -- Defines Python classes to proxy javascript types into Python. A complex file responsible for many of the core behaviors of pyodide.
