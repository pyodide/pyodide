...
def test_fetch_or_build_pypi(dummy_xbuildenv):
...
def test_fetch_or_build_pypi_with_deps_and_extras(dummy_xbuildenv):
    # TODO: - make test run without pyodide
    output_dir = dummy_xbuildenv / "dist"
...
def test_fake_pypi_succeed(dummy_xbuildenv, fake_pypi_url):
    # TODO: - make test run without pyodide
    output_dir = dummy_xbuildenv / "dist"
...
def test_fake_pypi_resolve_fail(dummy_xbuildenv, fake_pypi_url):
    output_dir = dummy_xbuildenv / "dist"
...
def test_fake_pypi_extras_build(dummy_xbuildenv, fake_pypi_url):
    # TODO: - make test run without pyodide
    output_dir = dummy_xbuildenv / "dist"
    # build package that resolves right
    app = typer.Typer()
...
def test_fake_pypi_repeatable_build(dummy_xbuildenv, fake_pypi_url):
    output_dir = dummy_xbuildenv / "dist"
...
def test_bad_requirements_text(dummy_xbuildenv):
    app = typer.Typer()
    app.command()(build.main)
